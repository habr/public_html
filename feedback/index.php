...
$form['form'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Запись на замер помещения',
		'title' => '<b>Запись на замер помещения</b><br>',
		'ajax' => false,
		'validate' => true,
		'from_email' => 'noreply@orend.ru',
		'from_name' => 'Натяжные потолки Идеал',
		'to_email' => 'kobalt18@gmail.com',
		'to_name' => 'Ideal',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'okay' => 'Заявка на запись отправлена! Мы свяжемся с вами для подтверждения заказа',
